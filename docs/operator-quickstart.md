# Operator Quickstart — Manufacture of knitted and crocheted fabrics

Shortest path from clone to a verified local dry-run for **ISIC 1391** (`cloud-itonami-isic-1391`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1391.git
cd cloud-itonami-isic-1391
```
...
- Blueprint governor key: `knitting-mill-operations-governor`
- Likely source path: `knittingops.governor.cljc`
